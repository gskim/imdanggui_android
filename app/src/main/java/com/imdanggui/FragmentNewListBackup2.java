 ...
 */
public class FragmentNewListBackup2 extends Fragment{
    int scrollCnt = 0;
    public FragmentNewListBackup2() {
        Dlog.d("생성자");
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        relativeLayout = (RelativeLayout) getActivity().findViewById(R.id.realtive);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnPosting = (LinearLayout)view.findViewById(R.id.posting);
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (!recyclerView.canScrollVertically(1)) {
                    ...
                    try {
                        ...
                        addJS.put("type", "add");
                        addJS.put("lastId", totalItemCount -1 );
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                    scrollCnt++;
    ...
    private void initiatePopupWindow(){
        try {
            ...
            View layout = inflater.inflate(R.layout.popup_main, (ViewGroup) getActivity().findViewById(R.id.popup_element));
            SimpleDraweeView popup_img = (SimpleDraweeView)layout.findViewById(R.id.img_popup);
            String imageBaseUrl = "http://www.mydailylook.net/img/popup/";
            ...
            btnClosePopup = (BootstrapButton)layout.findViewById(R.id.btn_clost_popup);
