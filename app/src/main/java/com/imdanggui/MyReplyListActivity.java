...
import com.imdanggui.adapter.MyReplyAdapter;
...
public class MyReplyListActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        customDialog = new CustomDialog(MyReplyListActivity.this);
        ...
        mLayoutManager = new LinearLayoutManager(MyReplyListActivity.this);
        ...
        recycler_view.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (!recyclerView.canScrollVertically(1)) {
                    Dlog.d("======================");
                    lastId = reply_list.get(totalItemCount - 1).getId();
    ...
    private Handler confirmHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            //완료 후 실행할 처리 삽입
            mAdapter = new MyReplyAdapter(reply_list, list);
    ...
    private List<ReplyItem> getData() throws IOException {
        ...
        List<ReplyItem> oss = gson.fromJson(js, listType);
        Dlog.d(oss.toString());
        return oss;
    }
